...
int gf_w4_single_table_init(gf_t *gf)
{
  ...
  ZeroMemory(std->mult, sizeof(uint8_t) * GF_FIELD_SIZE * GF_FIELD_SIZE);
  ZeroMemory(std->div, sizeof(uint8_t) * GF_FIELD_SIZE * GF_FIELD_SIZE);
...
int gf_w4_double_table_init(gf_t *gf)
{
  ...
  ZeroMemory(mult, sizeof(uint8_t) * GF_FIELD_SIZE * GF_FIELD_SIZE);
  ZeroMemory(std->div, sizeof(uint8_t) * GF_FIELD_SIZE * GF_FIELD_SIZE);
  ...
  ZeroMemory(std->mult, sizeof(uint8_t) * GF_FIELD_SIZE * GF_FIELD_SIZE * GF_FIELD_SIZE);
...
int gf_w4_quad_table_lazy_init(gf_t *gf)
{
  ...
  ZeroMemory(std->smult, sizeof(uint8_t) * GF_FIELD_SIZE * GF_FIELD_SIZE);
  ZeroMemory(std->div, sizeof(uint8_t) * GF_FIELD_SIZE * GF_FIELD_SIZE);
